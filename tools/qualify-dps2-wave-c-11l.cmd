...
echo ============================================================
echo DPS2 0.11.0 - Wave C Phase 11L Qualification
echo Steps 09-13: Services / Access / Compliance / Pricing / Tax
echo ============================================================
echo [1/6] Phase 11L Oracle qualification...
call tools\apply-dps2-phase11l.cmd
...
echo [5/6] Phase 11L Runtime E2E...
node tools\runtime-dps2-phase11l-wave-c-e2e.mjs
if errorlevel 1 exit /b 50
echo [6/6] Qualification complete.
echo ============================================================
echo DPS2_WAVE_C_11L_QUALIFICATION_PASS
echo ============================================================
endlocal & exit /b 0
