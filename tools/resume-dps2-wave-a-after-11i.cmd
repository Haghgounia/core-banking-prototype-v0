...
echo ============================================================
echo DPS2 0.11.0 - Wave A Resume after Phase 11I DB PASS
echo Phase 11I DB 29/29 is already qualified; continue from 11J.
echo ============================================================

echo [1/6] Phase 11J Oracle qualification...
...
echo [2/6] Stopping existing runtime...
call bin\stop.cmd
set "RC=%ERRORLEVEL%"
if not "%RC%"=="0" (
...
echo [4/6] Starting runtime in a separate window...
...
echo [5/6] Phase 11I Runtime E2E...
...
echo [6/6] Phase 11J Runtime E2E...
