...
echo ============================================================
echo DPS2 0.11.0 - Phase 11N-A Qualification
echo Step 00 - Read-only Operational Dashboard
echo ============================================================
echo [1/6] Phase 11N-A Oracle qualification...
call tools\apply-dps2-phase11na.cmd
...
echo [5/6] Phase 11N-A Runtime E2E...
node tools\runtime-dps2-phase11na-step00-dashboard-e2e.mjs
if errorlevel 1 exit /b 50

echo [6/6] Qualification complete.
echo ============================================================
echo DPS2_PHASE11NA_STEP00_DASHBOARD_QUALIFICATION_PASS
echo ============================================================
endlocal & exit /b 0
