...
echo ============================================================
echo DPS2 0.11.0 - Phase 11K Limit Usage Hotfix Qualification
echo Existing evidence retained: 11K Oracle DB 34/34 PASS.
echo ============================================================

echo [1/5] Phase 11K static verification...
node tools\verify-dps2-wave-b-statements-limits-maturity-11k.mjs
...
echo [5/5] Phase 11K Runtime E2E...
node tools\runtime-dps2-phase11k-wave-b-e2e.mjs
if errorlevel 1 exit /b 50

echo ============================================================
echo DPS2_PHASE11K_LIMIT_USAGE_HOTFIX_QUALIFICATION_PASS
echo ============================================================
endlocal & exit /b 0
