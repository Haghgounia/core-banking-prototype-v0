...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'four-deposits/batch-opening', loadComponent: () => import('./features/four-deposits/deposit-opening-batch.component').then(m => m.DepositOpeningBatchComponent)},
      ...
      {path: 'four-deposits/runtime-readiness', loadComponent: () => import('./features/four-deposits/deposit-opening-runtime-readiness.component').then(m => m.DepositOpeningRuntimeReadinessComponent)},
      {path: 'four-deposits/account-operations', loadComponent: () => import('./features/four-deposits/deposit-account-operations.component').then(m => m.DepositAccountOperationsComponent)},
