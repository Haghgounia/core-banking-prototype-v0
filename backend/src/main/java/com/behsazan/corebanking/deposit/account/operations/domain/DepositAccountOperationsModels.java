...
public final class DepositAccountOperationsModels {
    ...
    public record AccountStatusHistory(long accountStatusHistoryId,String fromStatusCode,String toStatusCode,OffsetDateTime effectiveAt,String reasonCode,String eventReference,Long approvalRequestId,String createdBy) {}
